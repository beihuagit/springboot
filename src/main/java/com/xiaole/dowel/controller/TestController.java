...
import com.xiaole.dowel.annotation.AccessLimit;
import com.xiaole.dowel.annotation.ApiIdempotent;
...
public class TestController {
    ...
    public String sendTopicMessage1() {
        testService.sendTopic("topicExchange", "topic.man", "M A N");
        return "ok";
    }

    @GetMapping("/sendTopicMessage2")
    public String sendTopicMessage2() {
        testService.sendTopic("topicExchange", "topic.woman","woman is all");
        return "ok";
    }
}
