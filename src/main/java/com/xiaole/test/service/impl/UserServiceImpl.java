...
import com.xiaole.test.common.Constant;
...
import com.xiaole.test.mapper.UserMapper;
...
import com.xiaole.test.service.UserService;
import com.xiaole.test.service.batch.mapperproxy.MapperProxy;
import com.xiaole.test.util.JedisUtil;
import com.xiaole.test.util.JodaTimeUtil;
...
public class UserServiceImpl implements UserService {
    ...
    private void saveAndSendMsg(User user) {
        ...
        rabbitTemplate.convertAndSend(RabbitDirectQueueConfig.LOGIN_LOG_EXCHANGE_NAME, RabbitDirectQueueConfig.LOGIN_LOG_ROUTING_KEY_NAME, MessageHelper.objToMsg(loginLog), correlationData);

        MsgLog msgLog = new MsgLog(msgId, loginLog, RabbitDirectQueueConfig.LOGIN_LOG_EXCHANGE_NAME, RabbitDirectQueueConfig.LOGIN_LOG_ROUTING_KEY_NAME);
